...
func TestDownloadMinuteFullCSV(t *testing.T) {
	...
	if !strings.Contains(content, "2024-01-02T00:00:00Z,100.100,101.100,99.100,100.600,0.200,1100,100.000,101.000,99.000,100.500,100.200,101.200,99.200,100.700") {
